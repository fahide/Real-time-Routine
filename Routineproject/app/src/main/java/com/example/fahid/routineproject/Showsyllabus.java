...
public class Showsyllabus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showsyllabus);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem) {
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Showsyllabus.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Showsyllabus.this).execute();
                ...
                if (FinalJSonObject != null) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            period1holder = jsonObject.getString("Course_code").toString();
                            period2holder = jsonObject.getString("Course_title").toString();
                            period3holder = jsonObject.getString("Credits").toString();
                            period4holder = jsonObject.getString("Course_code");
                            period5holder = jsonObject.getString("Course_title");
                            period6holder = jsonObject.getString("Credits");
