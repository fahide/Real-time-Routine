...
public class Showsnglday2nd extends AppCompatActivity {

    Httpparser httpParse = new Httpparser();
    ProgressDialog pDialog;

    // Http Url For Filter Student Data from Id Sent from previous activity.
    String HttpURL = "https://ffahid11.000webhostapp.com/single2nd.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showsnglday2nd);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem) {
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Showsnglday2nd.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Showsnglday2nd.this).execute();
