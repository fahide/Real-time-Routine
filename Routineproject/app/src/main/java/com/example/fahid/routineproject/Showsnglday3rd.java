...
public class Showsnglday3rd extends AppCompatActivity {

    Httpparser httpParse = new Httpparser();
    ProgressDialog pDialog;

    // Http Url For Filter Student Data from Id Sent from previous activity.
    String HttpURL = "https://ffahid11.000webhostapp.com/single3rd.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showsnglday3rd);
        setTitle("Third Year");
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem) {
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Showsnglday3rd.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Showsnglday3rd.this).execute();
