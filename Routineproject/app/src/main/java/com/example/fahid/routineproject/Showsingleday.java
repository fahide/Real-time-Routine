...
public class Showsingleday extends AppCompatActivity {

    Httpparser httpParse = new Httpparser();
    ProgressDialog pDialog;

    // Http Url For Filter Student Data from Id Sent from previous activity.
    String HttpURL = "https://ffahid11.000webhostapp.com/singleday.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showsingleday);
        setTitle("First year");
      ...
      /*  UpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Showsingleday.this, MainActivity.class);

                // Sending Student Id, Name, Number and Class to next UpdateActivity.
                intent.putExtra("Id", TempItem);
                intent.putExtra("Name", period1holder);
                intent.putExtra("Number", period2holder);
                intent.putExtra("Class", period3holder);
                //intent.putExtra("Class", period4holder);
                //intent.putExtra("Class", period5holder);
    ...
    public void StudentDelete(final String StudentID) {
        ...
        class StudentDeleteClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog2 = ProgressDialog.show(Showsingleday.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Showsingleday.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem) {
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Showsingleday.this, "Loading Data", null, true, true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new GetHttpResponse(Showsingleday.this).execute();
