...
public class Main5Activity extends AppCompatActivity {
    ...
    Button ShowStudents,Showsyllabus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Showsyllabus=(Button) findViewById(R.id.b7);
        ...
        //  Toast.makeText(Main5Activity.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
        ...
        class StudentRegistrationClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
               super.onPreExecute();
                ...
                progressDialog = ProgressDialog.show(Main5Activity.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Main5Activity.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
